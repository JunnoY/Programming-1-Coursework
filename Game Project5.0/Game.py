...
def gamescreen():
    ...
    def startgame():
        ...
        with open('player.csv', 'r') as csvfile:
            ...
            scoreLabel = Label(playground, text="Score: " + str(score), font="Times 20 italic bold", bg="#ae7046",fg="black")
    ...
    def writenameandscore():
        ...
        with open('player.csv', 'r',newline="") as csvfile:
            ...
            for i in range(1,len(playerlist)):
                if playerlist[i][0] == playername: #overwrite playername
...
def leaderboardscreen():
    ...
    leaderboard = Canvas(mainframe, width=1260, height =720, bg="light blue")
    ...
    # Titile
    slogan = Label(leaderboard, text="Leadership Board", font="Algerian 48", fg="black", bg="light blue")
    ...
    with open('player.csv', 'r') as f:
        ...
        for n in playlist:
            n[1]=int(n[1])
        sortlist = sorted(playlist, key= lambda l:l[1], reverse =True)
        print(sortlist)
    ...
    #     writer = csv.writer(csvfile)
    #     writer.writerows(sorted_d)

        # oldlist = list(reader)
        # newlist = []
        # for i in range(1, len(oldlist)):
        #     pop = [float(row[1]) for row in reader]
        #     maxvalue = max(pop)
        #     print(maxvalue)
