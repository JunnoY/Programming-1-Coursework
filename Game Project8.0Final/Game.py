...
def gamescreen():
    global playground, collide, score, scoreLabel, Malehunter, Femalehunter
    ...
    if Malehunter is True and Femalehunter is False:
        hunterImg = PhotoImage(file="hunter.png")
        hunter = playground.create_image(300, 500, image=hunterImg)
    elif Malehunter is False and Femalehunter is True:
        hunterImg = PhotoImage(file="femalehunter.png")
        hunter = playground.create_image(300, 500, image=hunterImg)
...
def startscreen():
    global menu, iconhunterImg, Malehunter, Femalehunter
    if Malehunter is True and Femalehunter is False:
        iconhunterImg = PhotoImage(file="huntermed.png")
    elif Malehunter is False and Femalehunter is True:
        iconhunterImg = PhotoImage(file="iconfemalehunter.png")
    ...
    malebutton = Button(menu, text="Male", command=malemode,bg="#ae7046", font="Algerian 24")
    malebutton.place(x=640, y=250)
    femalebutton = Button(menu, text="Female", command=femalemode, bg="#ae7046",font="Algerian 24")
    femalebutton.place(x=640, y=360)
...
#Character mode
def malemode():
    global Malehunter, Femalehunter, menu
    menu.destroy()
    Malehunter = True
    Femalehunter = False
    startscreen()
...
def leaderboardscreen():
    ...
    with open('player.csv', 'r',newline="") as csvfile:
         ...
         for line in reader:
             if place > 0:
                 leaderboard.create_text(350, y_axis, text=str(place), font="Broadway 24")
             place += 1
